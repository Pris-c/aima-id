 ...
 */
enum class DocType {
    PASSPORT, RESIDENCE_VISA, VISA, RESIDENT_PERMIT, ADDRESS_PROOF, EMPLOYMENT_CONTRACT, CRIMINAL_RECORD, SCHOOL_REGISTRATION, HEALTH_INSURANCE, NIF, NISS, CITIZENSHIP_ID, PROOF_INCOME
}